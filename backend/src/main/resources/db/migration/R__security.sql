...
insert into uicontrols(id, name) values(1100, 'page/dashboard/gantt');
...
insert into roles_uicontrols(role_id, uicontrol_id) values(1, 1100);
...
insert into roles_uicontrols(role_id, uicontrol_id) values(2, 1100);
