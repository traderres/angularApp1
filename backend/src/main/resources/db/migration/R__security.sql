...
insert into uicontrols(id, name) values(1050, 'page/recent-searches');
...
insert into roles_uicontrols(role_id, uicontrol_id) values(1, 1050);
...
insert into roles_uicontrols(role_id, uicontrol_id) values(2, 1050);
