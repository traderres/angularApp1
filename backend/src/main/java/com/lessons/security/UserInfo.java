...
public class UserInfo implements UserDetails, Serializable{
    ...
    private boolean userAcknoledgedMessage = false;
    ...
    public boolean getUserAcknoledgedMessage() {
        return userAcknoledgedMessage;
    }

    public void setUserAcknoledgedMessage() {
        this.userAcknoledgedMessage = true;
    }
}
